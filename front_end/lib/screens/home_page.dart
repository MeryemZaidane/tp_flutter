...
import 'package:front_end/screens/add_show_page.dart';
import 'package:front_end/screens/profile_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> deleteShow(int id) async {
    final response =
        await http.delete(Uri.parse('${ApiConfig.baseUrl}/shows/$id'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text("Show App"), backgroundColor: Colors.blueAccent),
      drawer: Drawer(
        child: ListView(
          children: [
            const DrawerHeader(
